...
if (! function_exists('country')) {
     ...
     * @return \Epigra\LaravelInt\Country|string
     */
...
if (! function_exists('currency')) {
     ...
     *
     * @return \Epigra\LaravelInt\Currency|string
     */
    function currency()
    {
...
if (! function_exists('language')) {
     ...
     * @return \Epigra\LaravelInt\Language|string
     */
...
if (! function_exists('number')) {
     ...
     * @param array $options
     * @return \Epigra\LaravelInt\Number|string
     */
